...
def train_one_epoch(model: torch.nn.Module, criterion: DistillationLoss,
                    ...
                    set_training_mode=True, tb_logger=None, start_idx=0, mimic=False, amp_autocast=suppress):
...
@torch.no_grad()
def evaluate(data_loader, model, device, model_ema=None, fp16=True, amp_autocast=suppress):
